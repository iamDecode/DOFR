...
var debug = require("debug")("DOFR:VirtualMachineManager"),
...
var VirtualMachineManager = Obj.extend({}, {
	createVM: function() {
		...
		return vm.start().then(function() {
			...
			return new Promise(function(resolve, reject) {
				vm.subscribeHeartbeat(function() {
					vm.unsubscribeHeartbeat();
					Logging.vmAlive(vm.uuid);
					resolve(vm);
				});
			});
		});
	...
	/**
	 * Get the uuid of the calling VM.
	 * @returns {*}
	 */
	getUuid: function() {
