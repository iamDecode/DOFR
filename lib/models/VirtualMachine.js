...
var VirtualMachine = Obj.extend({
	...
	getActiveJobs: function(limit) {
		return kue.getQueue().rangeByTypeAsync("jobs/" + this.uuid, "active", 0, limit, "asc");
	},
	 ...
	 * @returns {*}
	 */
	getInactiveJobs: function(limit) {
		return kue.getQueue().rangeByTypeAsync("jobs/" + this.uuid, "inactive", 0, limit, "asc");
	},
